(function () {
    ...
    let boutons_categorie = document.querySelectorAll(".bouton_cube");
    let restapi = document.querySelector(".contenu__restapi");

    boutons_categorie.forEach(elm => {
        elm.addEventListener("click", function (e) {
            let categorie = e.target.id; // Extract the category ID from the button ID
            console.log("Selected category:", categorie);

            let url = `https://gftnth00.mywhc.ca/tim23/wp-json/wp/v2/posts?categories=${categorie}`;
